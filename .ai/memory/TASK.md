...
## Checklist
- [x] v1.0 — CLI + hooks + installers shipped
- [x] v1.1 — three-way debate hardening (locking, fencing, sanitizer)
- [x] v1.2 — Windsurf fix, node guard, doctor hook-exec check, COMPATIBILITY.md, digest upgrades, hygiene
- [x] v1.3.6 — `memo search` (zero-dep BM25, CN/EN tokenizer) + monthly consolidate archive
- [x] v1.3.7 — cross-tool deepening: Gemini settings, Cursor hooks.json, AGENTS.md "as of" stamp, doctor Codex 32KiB warn
- [x] v1.3.8 — `memo deinit` (dry-run default, --yes applies; preserves user content; strips git hook)
- [x] v1.3.9 — optional UserPromptSubmit staleness reminder hook (default off, throttled)
